...
pico: dirs make_pico.spec crystal-palace/ src/breakpoint_hook.c  src/payload.c
	...
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./make_pico.spec x64 out/hwbp_pico.o
...
runner: dirs libtcg pico make_runner.spec crystal-palace/ src/runner.c
	...
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./make_runner.spec x64 out/runner.bin
...
tester: dirs libtcg libcpltest runner crystal-palace/ make_tester.spec src/runner.c
	...
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./make_pico.spec x64 out/hwbp_pico.test.o
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./make_tester.spec x64 out/tester.bin
